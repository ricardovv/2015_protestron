...
$( "select" ).change(function () {
	...
	if($("#selcartel").val() == "cartel_5"){
		$("#cartel").css('background', 'Url(img/cartel_5.gif)  no-repeat center'); 
	}
...
//		alert(val_cmessage);
		...
		$('#box h2').text(	iframe1	+ url1 + urlval_bg + urlval_people 	+ urlval_cartel + urlval_p_a + urlval_p_b + urlval_p_c + urlval_p_d + urlval_cmessage + iframe2 );
